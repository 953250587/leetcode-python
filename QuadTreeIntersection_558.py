    ...
    def intersect(self, quadTree1, quadTree2):
        ...
        def dfs(root_1, root_2):
            ...
            if root_1.isLeaf:
                ...
                root.topLeft = dfs(root_1.topLeft, root_2.topLeft)
                root.bottomLeft = dfs(root_1.bottomLeft, root_2.bottomLeft)
                root.topRight = dfs(root_1.topRight, root_2.topRight)
                root.bottomRight = dfs(root_1.bottomRight, root_2.bottomRight)
                if root.bottomLeft.val and root.bottomRight.val and root.topLeft.val and root.topRight.val:
                    root.val = True
                    root.isLeaf = True
                    root.bottomRight = root.topRight = root.bottomLeft = root.topLeft = None
            return root
        return dfs(quadTree1, quadTree2)

    def intersect_1(self, q1, q2):
        """
        232ms
        :param q1:
        :param q2:
